...
matrix_train = confusion_matrix(y, svm.pred(X)).ravel()
matrix_test = confusion_matrix(y_test, svm.pred(X_test)).ravel()
print('Confusion Matrix on train set: \n', matrix_train.reshape((2, 2)))
print('Confusion Matrix on test set: \n', matrix_test.reshape((2, 2)))
